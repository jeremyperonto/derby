...
export const RIVALS: Rival[] = [
  ...
  },
  {
    id: 'tina',
    name: 'Tailfin Tina',
    tagline: '“A little dust? Never bother.”',
    intro: 'Tina’s Tailfin is sleek and heavy in the back, with mirror-polished axles — but she skimps on the graphite. Out-slick her wheels.',
    lesson: 'friction',
    tier: 3,
    design: rivalDesign(
      'tina',
  ...
  },
  {
    ...
    intro: 'The champ. Sleek, heavy in the back, mirror-polished and fully graphited — no gimmicks, just every trick done right. Bring your best build.',
    lesson: 'placement',
    tier: 3,
    design: rivalDesign(
      'lena',
